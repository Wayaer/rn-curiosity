...
+ (NSMutableDictionary *)getAppInfo;
{
    ...
    [info setObject:[app objectForKey:@"CFBundleShortVersionString"] forKey:@"Version"];
    [info setObject:[NSNumber numberWithInt:[[app objectForKey:@"CFBundleVersion"] intValue]] forKey:@"Build"];
