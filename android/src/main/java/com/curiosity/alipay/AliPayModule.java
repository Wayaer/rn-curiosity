...
public class AliPayModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void aliPayAuthWithInfo(final String infoStr, final Promise promise) {
  ...
  @ReactMethod
  public void aliPayInterceptorWithUrl(final String h5PayUrl, final Promise promise) {
    PayTask payTask = new PayTask(getCurrentActivity());
  ...
  @ReactMethod
  public void getAliPaySDKVersion(Promise promise) {
    PayTask payTask = new PayTask(getCurrentActivity());
